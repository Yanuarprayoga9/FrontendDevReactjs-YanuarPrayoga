...
import { applyFilters, getBooleanFromUrlParam, getUrlParam } from '../../utils/utils';
...
const Restaurants = () => {
    ...
    const [isOpen, setIsOpen] = useState<boolean | null | undefined>(getBooleanFromUrlParam(urlParams.get('isOpen')));
    const [priceRange, setPriceRange] = useState<string | null | undefined>(getUrlParam('priceRange'));
    const [category, setCategory] = useState<string | null >(getUrlParam('category') || null);
    // FILTER STATE END
    ...
    useEffect(() => {
        const fetchRestaurants = async () => {
            ...
            try {
                ...
                setFilteredRestaurants(applyFilters(fetchedRestaurants, isOpen, priceRange));
    ...
    return (
        <div className="min-h-screen w-full pb-52">
            ...
            <Filter isOpen={isOpen} setIsOpen={setIsOpen} category={category} setCategory={setCategory} priceRange={priceRange} setPriceRange={setPriceRange} />
